        ...
        <Col>
          <Card>
            <CardImg
              ...
              object-fit="cover"
              width="80%"
              src="https://www.fiat.it/content/dam/fiat/cross/models/500-family-2020/opening/desktop/figurini/500/Connect/500-Connect-Model-page-silver-with-glossy-black-roof-Car-Desktop-680x430.png"
              alt="Fiat 500 Cross"
            />
            <CardBody>
        ...
        <Col>
          <Card>
            <CardImg
              top
              width="100%"
              src="https://www.autoarona.it/images/vehicles/3444408/0/large"
              alt="Nuova Polo"
            />
            <CardBody>
        ...
        <Col>
          <Card>
            <CardImg
              top
              width="100%"
              src="https://motospia.it/motopiu/uploads/2021/02/KSR-classic-125.png"
              alt="KSR Classic 125"
            />
            <CardBody>
        ...
        <Col>
          <Card>
            <CardImg
              top
              width="100%"
              src="https://images-na.ssl-images-amazon.com/images/I/71kMHm8hrDL._AC_SL1500_.jpg"
            />
            <CardBody>

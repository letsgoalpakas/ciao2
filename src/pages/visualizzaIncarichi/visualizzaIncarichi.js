...
const Incarichi = () => {
    ...
    async function getIncarichi() {
        let response = await fetch("http://localhost:3001/getIncarichi", {
            method: "get",
            headers: {
  ...
  async function setOccupato(n){
        ...
        let response = await fetch("http://localhost:3001/dipendenteoccupato",{
                method: "post",
                headers: {
                  'Accept': 'application/json',
                  'Content-Type': 'application/json',
    ...
    async function getAssistenza(n){
        ...
        let dipendente = JSON.parse(localStorage.getItem("profile"));
        let response = await fetch("http://localhost:3001/assistenteoccupato",{
                method: "post",
                headers: {
                  'Accept': 'application/json',
                  'Content-Type': 'application/json',

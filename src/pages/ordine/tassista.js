...
const Tassista = () => {
    ...
    const addToDB = () => {
      let cliente = JSON.parse(localStorage.getItem("profile"));
        return fetch("http://localhost:3001/ordinetassista", {
               method: "post",
               headers: {
    ...
    return (
        ...
        <br></br>
        <br></br>	
        <Jumbotron>DOVE TI VENIAMO A PRENDERE?</Jumbotron>
        <br></br>
    ...
    <Button type="submit" style={{"align-items" : "center"}} onClick={controllo} color="primary" size="lg">Conferma</Button>	
        </body>
    );
}
